...
export const CreateTransferParamsSchema: z.ZodObject<{
	amount: z.ZodNumber
	date: z.ZodString
	fromAccountId: z.ZodNumber
	toAccountId: z.ZodNumber
	...
	fromAccountId: z.number().positive('fromAccountId must be a positive number'),
	toAccountId: z.number().positive('toAccountId must be a positive number'),
	comment: z
		.string()
